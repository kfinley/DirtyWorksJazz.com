<template>
  <img id="image" class="image" :src="image?.src" :alt="image?.alt" v-on:click="nextImage" />
</template>
...
const images = [
  ...
  {
    src: '/media/images/2025.06.13_01-Persona.jpg',
